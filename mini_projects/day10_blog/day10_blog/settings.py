"""
Django settings for day10_blog project.
...
SECRET_KEY = 'django-insecure-&+-paee&)bgmlkfx5+3&2^fep%00_5%+*xq#52!a$(170pthb='
...
TEMPLATES = [
    {
        ...
        "APP_DIRS": True,                  # <— also load app templates (e.g., blog/templates/)
        "OPTIONS": {
            "context_processors": [
...
REST_FRAMEWORK = {
    ...
    'PAGE_SIZE': 5,
    # Explicit read-only allowance for now
